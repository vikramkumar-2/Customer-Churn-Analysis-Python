...
<img src="images/churn-drivers/fig12_correlation_heatmap.png" width="600"/>
...
<p align="center">
  <img src="images/customer-overview/fig02_churn_count.png" width="45%"/>
  <img src="images/customer-overview/fig03_churn_percentage.png" width="45%"/>
</p>
...
<p align="center">
  <img src="images/churn-drivers/fig07_churn_by_contract.png" width="500"/>
</p>
...
<img src="images/customer-overview/fig05_churn_by_senior_citizen.png"/>

</td>
<td width="50%">

**Tenure Distribution by Churn**
<img src="images/customer-overview/fig06_tenure_distribution.png"/>
...
<img src="images/churn-drivers/fig09_churn_by_payment_method.png"/>

</td>
<td width="50%">

**Avg. Monthly Charges vs. Tenure**
<img src="images/churn-drivers/fig10_avg_monthly_charges_vs_tenure.png"/>
...
<p align="center">
  <img src="images/churn-drivers/fig08_service_subscriptions.png" width="800"/>
</p>

**Monthly Charges vs. Total Charges** (colored by churn status)

<p align="center">
  <img src="images/churn-drivers/fig11_monthly_vs_total_charges.jpeg" width="600"/>
</p>

> The complete, presentation-ready report with full commentary is available in [`Telco_Customer_Churn_Report.pdf`](./Telco_Customer_Churn_Report.pdf).
...
│   ├── customer-overview/               # Demographic & univariate churn charts
...
│   │
│   └── churn-drivers/                   # Contract, service, billing & correlation charts
...
│
├── Telco_customer_churn_final.ipynb     # Main analysis notebook (cleaning → EDA → hypothesis testing)
├── Telco_Customer_Churn.csv             # Raw dataset (7,043 records, 21 attributes)
...
git clone https://github.com/YOUR-GITHUB-USERNAME/telco-customer-churn-eda.git
...
jupyter notebook Telco_customer_churn_final.ipynb
```
